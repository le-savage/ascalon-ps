...
public class CustomObjects {
    ...
    private static final int[][] CLIENT_OBJECTS = {
            ...
            /*** AFK Area ***/
            {49522, 2734, 5332, 0, 0},//FISH
            {36959, 2734, 5329, 0, 0},//COMBAT
            {2023, 2731, 5325, 0, 0}, //TREE
            {5896, 2728, 5325, 0, 0},//ROCKS
            {56859, 2727, 5328, 0, 0},//STALL
            {40948, 2727, 5331, 0, 0}, //LOGS

            {22819, 2691, 5332, 0, 0}, //bank


            /*** Portal Area ***/
            {13620, 2710, 5319, 0, 0},//Yanille Poral
            ...
            /*** Alter ***/
            {409, 2691, 5330, 0, 0}, //Alter

            /*** Mining Carts ***/
            {6045, 2727, 5350, 0, 0}, //Cart
            {6045, 2733, 5337, 0, 0}, //Cart
            {6045, 2740, 5325, 0, 0}, //Cart
            {6045, 2746, 5325, 0, 0}, //Cart
            {6045, 2744, 5346, 0, 0}, //Cart

            /** Mining Rocks Missing from Map **/
            {11936, 2741, 5324, 0, 0}, //Copper
            {11936, 2737, 5325, 0, 0}, //Copper
            {11933, 2737, 5324, 0, 0}, //Tin
            {11963, 2748, 5323, 0, 0}, //Coal
            {11954, 2747, 5323, 0, 0}, //Coal
            {11947, 2743, 5341, 0, 0}, //Mithril
            {11941, 2745, 5341, 0, 0}, //Addy


            /*** Smithing Room ***/
            {22819, 2700, 5351, 0, 0}, //Bank Booth
            {22819, 2700, 5352, 0, 0}, //Bank Booth
            {22819, 2700, 5351, 0, 0}, //Bank Booth
            {22725, 2733, 5353, 0, 0}, //Golden Anvil
            {56031, 2738, 5350, 0, 0}, //Furnace Pt1
            {56032, 2735, 5350, 0, 0}, //Furnace Pt2
            {56034, 2733, 5350, 0, 0}, //Furnace Pt3
            {6096, 2738, 5352, 0, 0}, //Metal Foundry


            /*** Summoning Room ***/
            {22823, 2703, 5368, 0, 0}, //Crystal Chest

            /*** Crystal Chest & Burnt Chest ***/
            {172, 2699, 5352, 0, 0}, //Crystal Chest
            {6420, 2699, 5347, 0, 0}, //Burnt Chest

            /*** Bank Boothes ***/
            {22819, 2700, 5351, 0, 3}, //Bank Booth
            {22819, 2700, 5352, 0, 3}, //Bank Booth

            /*** Magic Trees ***/
            {1306, 2714, 5339, 0, 0}, //Magic Tree
            {1306, 2717, 5339, 0, 0}, //Magic Tree
            {1306, 2720, 5339, 0, 0}, //Magic Tree

            {1306, 2714, 5342, 0, 0}, //Magic Tree
            {1306, 2717, 5342, 0, 0}, //Magic Tree
            {1306, 2720, 5342, 0, 0}, //Magic Tree

            {1306, 2714, 5345, 0, 0}, //Magic Tree
            {1306, 2717, 5345, 0, 0}, //Magic Tree
            {1306, 2720, 5345, 0, 0}, //Magic Tree

            {1306, 2714, 5348, 0, 0}, //Magic Tree
            {1306, 2717, 5348, 0, 0}, //Magic Tree
            {1306, 2720, 5348, 0, 0}, //Magic Tree
    ...
    public static void globalFiremakingTask(final GameObject fire, final Player player, final int cycles) {
        ...
        TaskManager.submit(new Task(cycles) {
            ...
            public void execute() {
                ...
                if (player.getInteractingObject() != null && (player.getInteractingObject().getId() == 38828)) {
