...
public class ProfileViewing {
    ...
    public static long getAccountWorth(Player other) {
        long amount = 0;
        ...
        for (Item item : other.getInventory().getValidItemsArray()) {
            ...
            amount += item.getDefinition().getValue() * item.getAmount();
        }
        ...
        for (Bank bank : other.getBanks()) {
            ...
            for (Item item : bank.getValidItemsArray()) {
                amount += item.getDefinition().getValue() * item.getAmount();//TODO
            }
        }
        return amount;
    }
