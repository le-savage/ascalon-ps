...
public class PointsHandler {
    ...
    public void incrementPrestigePoints() {
        this.prestigePoints++;
    }

    public void incrementPrestigePoints(int amt) {
        this.prestigePoints += amt;
    }
    ...
    public int getAfkPoints() {
        return afkPoints;
    }

    public void setAfkPoints(int afkPoints, boolean add) {
        if (add)
            this.afkPoints += afkPoints;
        else
            this.afkPoints = afkPoints;
    }

    public void incrementAfkPoints(double amount) {
        this.afkPoints += amount;
    }
