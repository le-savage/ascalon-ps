...
import com.janus.world.content.combat.CombatContainer.CombatHit;
...
import com.janus.world.content.combat.range.CombatRangedAmmo.AmmunitionData;
import com.janus.world.content.combat.range.CombatRangedAmmo.RangedWeaponData;
import com.janus.world.content.combat.range.CombatRangedAmmo.RangedWeaponType;
...
public class DefaultRangedCombatStrategy implements CombatStrategy {
    ...
    public static void decrementAmmo(Player player, Position pos) {
       // System.out.println("Decrement Ammo method called for " + player.getUsername());
