package com.janus.world.content.skill.impl.slayer;
...
import com.janus.world.content.Emotes.Skillcape_Data;
...
public class Slayer {
    ...
    public void assignTask() {
        ...
        if (duoSlayer) {
            ...
            player.getPacketSender().sendRichPresenceState("Duo Slayer with " + duoPartner + "!");
