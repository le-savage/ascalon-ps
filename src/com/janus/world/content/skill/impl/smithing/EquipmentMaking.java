...
public class EquipmentMaking {
	...
	public static void smithItem(final Player player, final Item bar, final Item itemToSmith, final int x) {
		int[] list = new int[] {1205, 1351, 1422, 1139, 9375, 9377, 9378, 9379, 9380, 9381, 1277, 4819, 1794, 819, 39, 1321, 1265, 1291, 9420, 1155, 864, 1173,
				...
				1185, 1347, 1373, 1113, 1201, 3101, 1319, 1093, 1079, 1127, 2, 1083, 1349, 1215,  1305,  4587,  1249,  7158,  6739,  1434,  20555,
				1377,  14484,  3140,  4087, 4585,  14479,  1149,  11335,  11232,  11237,  15259, 11732, 17926, 4716,4753,4724,4745,4708,4720,4757,4728,
				4749,4712,4722,4759,4730,4751,4714,4718,4755,4726,4747,4710,4732,4736,4738,4734,4740,
				11694,11718,11720,11722,11696,11724,11726,11728,10350,10348,10346,10352,14008,14009,14010};
		if(bar.getId() < 0)
			return;
			...
			public void execute() {
				...
				if(player.getInteractingObject() != null)
					if (IntStream.of(list).anyMatch(id -> id == itemToSmith.getId())) {
						...
						World.sendMessage("[ALERT] "+player.getUsername()+" has been banned for attempting to hack smithing.");
...
/*** New Method ********* New Method ************************************ *** New Method ************************************ ****** New Method ************************************ *************************** ***/
