...
public class PlayerRelations {
    ...
    public void message(Player friend, byte[] message, int size) {
        ...
        /*PlayerLogs.log(player.getUsername(),"[PRIVATE TO]: "+friend.getUsername()+": "+str);*/
        PlayerLogs.logMasterChatLog("PrivateChatLog", "[PRIVATE FROM]: " + player.getUsername() + " [TO]: " + friend.getUsername() + ": " + str);
        /*PlayerLogs.logMasterChatLog("MasterChatLog", "[PRIVATE FROM]: "+player.getUsername()+" [TO]: "+friend.getUsername()+": "+str);*/
        //DiscordMessenger.sendPrivateMessage("[PRIVATE FROM]: "+player.getUsername()+" [TO]: "+friend.getUsername()+": "+str);
