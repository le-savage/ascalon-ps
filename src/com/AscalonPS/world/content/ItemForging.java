...
public class ItemForging {
    ...
    private static enum ItemForgeData {
        ...
        ETERNAL_BOOTS(new Item[]{new Item(13227), new Item(6920)}, new Item(13235), new int[]{6, 60, 0}),
        PEGASIAN_BOOTS(new Item[]{new Item(13229), new Item(2577)}, new Item(12708), new int[]{6, 60, 0}),
        PRIMORDIAL_BOOTS(new Item[]{new Item(13231), new Item(11732)}, new Item(13239), new int[]{6, 60, 0}),


        //Replaced with ItemActionPacketListner Version
        // ABYSSAL_BLUDGEON(new Item[] {new Item(13274), new Item(13275), new Item(13276), new Item(13279)}, new Item(13045), new int[] {1, -1, 0}),
