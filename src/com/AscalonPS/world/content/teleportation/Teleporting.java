package com.AscalonPS.world.content.teleportation;
...
public class Teleporting {
     ...
     *
     * @param client The player.teleporting to the destination.    //sec
     ...
     *
     * @param client      The player.teleporting to a training area.
     * @param destination The destination being teleported to.
     */
     ...
     *
     * @param client      The player.teleporting to a minigame area.
     * @param destination The destination being teleported to.
     */
     ...
     *
     * @param client      The player.teleporting to a bosses area.
     * @param destination The destination being teleported to.
     */
     ...
     *
     * @param client      The player.teleporting to a player killing area.
     * @param destination The destination being teleported to.
     */
     ...
     *
     * @param client      The player.teleporting to a skilling area.
     * @param destination The destination being teleported to.
     */
     ...
     *
     * @param client      The player.teleporting to a donator area.
     * @param destination The destination being teleported to.
     */
