...
public class TeleportPlayerKilling extends Teleporting {
    ...
    public static enum PlayerKilling {
        ...
        TELEPORT_10(new String[]{"Thermo", "Smoke Devil"}, new int[]{2388, 4692, 0}),
        TELEPORT_11(new String[]{"Crazy Lvl 2", "Man"}, new int[]{1959, 4759, 0}),
        TELEPORT_12(new String[]{"Zulrah", "use ::instance"}, new int[]{3429, 3538, 10});
         ...
         * @param teleportName2       The secondary name of the teleport.
         * @param teleportCoordinates The coordinates of the teleport.
         */
