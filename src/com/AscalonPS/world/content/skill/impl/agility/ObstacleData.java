package com.AscalonPS.world.content.skill.impl.agility;
...
public enum ObstacleData {
    ...
    /*LOGV2(2296, true) {
        ...
        public void cross(final Player player) {
            player.setSkillAnimation(762);
            player.getUpdateFlag().flag(Flag.APPEARANCE);
            player.moveTo(new Position(3092, 3479));
            player.getPacketSender().sendMessage("You attempt to walk across the log..");
            TaskManager.submit(new Task(1, player, false) {
                int tick = 7;
            ...
            TaskManager.submit(new Task(1, player, false) {
                ...
                public void execute() {
                    if (tick == 2) {
                        ...
                        player.moveTo(new Position(player.getPosition().getX(), player.getPosition().getY() - 2, 1));
        ...
        public void cross(final Player player) {
            ...
            TaskManager.submit(new Task(2, player, false) {
                ...
                public void execute() {
                    ...
                    player.moveTo(new Position(player.getPosition().getX(), player.getPosition().getY() - 2, 2));
    ...
    PIPE_1(4058, true) {
        @Override
        public void cross(final Player player) {
            player.moveTo(new Position(3091, 3479));
            //player.moveTo(new Position(player.getPosition().getX(), player.getPosition().getY() + 6, 0));
