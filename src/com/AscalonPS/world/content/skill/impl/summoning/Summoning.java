package com.AscalonPS.world.content.skill.impl.summoning;

import com.AscalonPS.engine.task.Task;
import com.AscalonPS.engine.task.TaskManager;
import com.AscalonPS.engine.task.impl.FamiliarSpawnTask;
import com.AscalonPS.model.*;
import com.AscalonPS.model.Locations.Location;
import com.AscalonPS.model.container.impl.BeastOfBurden;
...
import com.AscalonPS.world.content.skill.impl.summoning.BossPets.BossPet;
...
public class Summoning {
    ...
    public void login() {
        clearInterface();
        if (spawnTask != null) {
            if (!PlayerPunishment.hasClaimedDailyRewardIP(player.getHostAddress()) || !PlayerPunishment.hasClaimedDailyRewardUID(player.getMac())) {
                player.getPacketSender().sendMessage("You had a familiar. To claim your daily reward, use ::dailyreward");
            }
