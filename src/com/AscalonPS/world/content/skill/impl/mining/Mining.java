...
import com.AscalonPS.world.content.ShootingStar;
import com.AscalonPS.world.content.Sounds;
import com.AscalonPS.world.content.Sounds.Sound;
import com.AscalonPS.world.content.skill.impl.mining.MiningData.Ores;
                ...
                if (miningLevel >= o.getLevelReq()) {
                    ...
                    if (miningLevel >= p.getReq()) {
                        ...
                        player.setCurrentTask(new Task(delay >= 2 ? delay : 1, player, false) {
                            ...
                            @Override
                            public void execute() {
                                player.getPacketSender().sendRichPresenceState("Mining Rocks!");
