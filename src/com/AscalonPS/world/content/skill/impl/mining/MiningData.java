package com.AscalonPS.world.content.skill.impl.mining;
...
public class MiningData {
    ...
    public static enum Ores {
        ...
        Copper(new int[]{9708, 9709, 9710, 11936, 11960, 11961, 11962, 11189, 11190, 11191, 29231, 29230, 2090}, 1, 450, 436, 4, 4),
        Tin(new int[]{9714, 9715, 9716, 11933, 11957, 11958, 11959, 11186, 11187, 11188, 2094, 29227, 29229}, 1, 450, 438, 4, 4),
        Iron(new int[]{9717, 9718, 9719, 2093, 2092, 11954, 11955, 11956, 29221, 29222, 29223}, 15, 550, 440, 5, 5),
        Silver(new int[]{2100, 2101, 29226, 29225, 11948, 11949}, 20, 300, 442, 5, 7),
        Coal(new int[]{2097, 5770, 29216, 29215, 29217, 11965, 11964, 11963, 11930, 11931, 11932}, 30, 600, 453, 5, 7),
        Gold(new int[]{9720, 9721, 9722, 11951, 11183, 11184, 11185, 2099}, 40, 350, 444, 5, 10),
        Mithril(new int[]{25370, 25368, 5786, 5784, 11942, 11943, 11944, 11945, 11946, 29236, 11947, 11942, 11943}, 50, 900, 447, 6, 11),
        Adamantite(new int[]{11941, 11939, 29233, 29235}, 70, 1200, 449, 7, 14),
        Runite(new int[]{14860, 14859, 4860, 2106, 2107}, 85, 2000, 451, 7, 20),

        CRASHED_STAR(new int[]{38660}, 80, 700, 13727, 7, -1);
