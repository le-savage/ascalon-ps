package com.AscalonPS.world.content.skill.impl.runecrafting;
...
import com.AscalonPS.world.content.skill.impl.runecrafting.RunecraftingData.RuneData;
import com.AscalonPS.world.content.skill.impl.runecrafting.RunecraftingData.TalismanData;
...
public class Runecrafting {
    ...
    public static void craftRunes(final Player player, RunecraftingData.RuneData rune) {
        player.getPacketSender().sendRichPresenceState("Creating Runes!");
