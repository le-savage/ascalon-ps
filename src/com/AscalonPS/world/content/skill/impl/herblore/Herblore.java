package com.AscalonPS.world.content.skill.impl.herblore;
...
public class Herblore {
    ...
    public static boolean cleanHerb(final Player player, final int herbId) {
        player.getPacketSender().sendRichPresenceState("Cleaning Herbs");
        player.getPacketSender().sendSmallImageKey("herblore");
        player.getPacketSender().sendRichPresenceSmallPictureText("Lvl: " + player.getSkillManager().getCurrentLevel(Skill.HERBLORE));
    ...
    public static boolean makeUnfinishedPotion(final Player player, final int herbId) {
        ...
        if (player.getInventory().contains(VIAL) && player.getInventory().contains(unf.getHerbNeeded())) {
            ...
            TaskManager.submit(new Task(1, player, false) {
                public void execute() {
                    player.getPacketSender().sendRichPresenceState("Brewing Potions..");
                    player.getPacketSender().sendSmallImageKey("herblore");
                    player.getPacketSender().sendRichPresenceSmallPictureText("Lvl: " + player.getSkillManager().getCurrentLevel(Skill.HERBLORE));
