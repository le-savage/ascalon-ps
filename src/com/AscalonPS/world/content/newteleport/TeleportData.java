package com.AscalonPS.world.content.newteleport;
...
public enum TeleportData {
    ...
    TIERED_BOSSES("Tiered Boss", 50, new Position(BossMinigameFunctions.DOOR.getX(), BossMinigameFunctions.DOOR.getY()), Categories.MINIGAMES),
