package com.AscalonPS.world.content.clan;
...
public class ClanChatManager {
    ...
    public static void sendMessage(Player player, String message) {
        ...
        String difficultyColour = "<col=1e5f63>";
        for (Player memberPlayer : clan.getMembers()) {
            if (memberPlayer != null) {
                ...
                memberPlayer.getPacketSender().sendMessage("@clan:A@" + bracketColor + "[" + clanNameColor + clan.getName() + bracketColor + "]" + nameColor + "" + rankImg + "" +
                        NameUtils.capitalizeWords(player.getUsername()) + bracketColor + " [" + difficultyColour + difficulty + bracketColor + "] " + nameColor + ": " + chatColor + message);
            }
        }
    }
