...
public class Graveyard {
    ...
    public static void start(Player player) {
        player.getPacketSender().sendRichPresenceState("Slaughtering Zombies");
        player.getPacketSender().sendRichPresenceSmallPictureText("Fragments: " + player.getInventory().getAmount(14667));
