...
public class Scoreboards {
    ...
    public static void init() {
        ...
        TOP_KILLSTREAKS = new Scoreboard("Janus's Top Killstreaks", "top-killstreaks.txt") {
            @Override
            public void resort(ArrayList<ScoreboardEntry> entries) {
        ...
        TOP_ACHIEVER = new Scoreboard("Janus's Top Achiever", "top-achievers.txt") {
            @Override
            public void resort(ArrayList<ScoreboardEntry> entries) {
                Scoreboards.resort(entries, "integer");
            }
        ...
        TOP_TOTAL_EXP = new Scoreboard("Janus's Top Total Exp", "top-exp.txt") {
            @Override
            public void resort(ArrayList<ScoreboardEntry> entries) {
