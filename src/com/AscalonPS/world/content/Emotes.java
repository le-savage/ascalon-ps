...
public class Emotes {
    ...
    public enum Skillcape_Data {
        ATTACK(new int[]{9747, 9748, 10639, 21003},
                4959, 823, 7),
        DEFENCE(new int[]{9753, 9754, 10641, 21007},
                4961, 824, 10),
        STRENGTH(new int[]{9750, 9751, 10640, 21022},
                4981, 828, 25),
        CONSTITUTION(new int[]{9768, 9769, 10647, 21001},
                14242, 2745, 12),
        RANGED(new int[]{9756, 9757, 10642, 21018},
                4973, 832, 12),
        PRAYER(new int[]{9759, 9760, 10643, 21016},
                4979, 829, 15),
        MAGIC(new int[]{9762, 9763, 10644, 21014},
                4939, 813, 6),
        COOKING(new int[]{9801, 9802, 10658, 21005},
                4955, 821, 36),
        WOODCUTTING(new int[]{9807, 9808, 10660, 21025},
                4957, 822, 25),
        FLETCHING(new int[]{9783, 9784, 10652, 21011},
                4937, 812, 20),
        FISHING(new int[]{9798, 9799, 10657, 21010},
                4951, 819, 19),
        FIREMAKING(new int[]{9804, 9805, 10659, 21009},
                4975, 831, 14),
        CRAFTING(new int[]{9780, 9781, 10651, 21006},
                4949, 818, 15),
        SMITHING(new int[]{9795, 9796, 10656, 21021},
                4943, 815, 23),
        MINING(new int[]{9792, 9793, 10655, 21015},
                4941, 814, 8),
        HERBLORE(new int[]{9774, 9775, 10649, 21012},
                4969, 835, 16),
        AGILITY(new int[]{9771, 9772, 10648, 21002},
                4977, 830, 8),
        THIEVING(new int[]{9777, 9778, 10650, 21024},
                4965, 826, 16),
        SLAYER(new int[]{9786, 9787, 10653, 21020},
                4967, 1656, 8),
        FARMING(new int[]{9810, 9811, 10661, 21008},
                4963, -1, 16),
        RUNECRAFTING(new int[]{9765, 9766, 10645, 21019},
                4947, 817, 10),
        CONSTRUCTION(new int[]{9789, 9790, 10654, 21004},
                4953, 820, 16),
        HUNTER(new int[]{9948, 9949, 10646, 21013},
                5158, 907, 14),
        SUMMONING(new int[]{12169, 12170, 12524, 21023},
                8525, 1515, 10),
        DUNGEONEERING(new int[]{18508, 18509},
                -1, -1, 15),
        DUNGEONEERING_MASTER(new int[]{19709, 19710},
                -1, -1, 15),
        QUEST_POINT(new int[]{9813, 9814, 10662, 21017},
                4945, 816, 19);
