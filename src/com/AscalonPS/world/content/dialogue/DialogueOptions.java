package com.AscalonPS.world.content.dialogue;
...
import com.AscalonPS.world.content.Gambling.FlowersData;
import com.AscalonPS.world.content.clan.ClanChatManager;
import com.AscalonPS.world.content.combat.bossminigame.BossRewardChest;
import com.AscalonPS.world.content.combat.magic.MagicSpells;
import com.AscalonPS.world.content.combat.magic.Spell;
import com.AscalonPS.world.content.dialogue.impl.AgilityTicketExchange;
import com.AscalonPS.world.content.dialogue.impl.Mandrith;
import com.AscalonPS.world.content.minigames.impl.Graveyard;
...
import com.AscalonPS.world.content.skill.impl.dungeoneering.DungeoneeringFloor;
import com.AscalonPS.world.content.skill.impl.herblore.Decanting;
import com.AscalonPS.world.content.skill.impl.mining.Mining;
...
import com.AscalonPS.world.content.skill.impl.slayer.SlayerMaster;
...
import com.AscalonPS.world.content.transportation.JewelryTeleporting;
import com.AscalonPS.world.content.transportation.TeleportHandler;
import com.AscalonPS.world.content.transportation.TeleportType;
import com.AscalonPS.world.entity.impl.npc.NPC;
import com.AscalonPS.world.entity.impl.npc.NpcAggression;
        ...
        if (id == FIRST_OPTION_OF_FIVE) {
            switch (player.getDialogueActionId()) {
                ...
                case 38:
                    ...
                    player.getPacketSender().sendRichPresenceState("King Black Dragon");
            ...
            switch (player.getDialogueActionId()) {
                ...
                case 2:
                    ...
                    break;
                case 9:
                    player.getPacketSender().sendMessage("Please let staff know about this. Error 92P76!");
                    break;
                case 10:
                ...
                case 48:
                    ...
                    break;
                case 59:
                    if (player.getClickDelay().elapsed(1500)) { //follow this
            ...
            switch (player.getDialogueActionId()) {
                ...
                case 2:
                    ...
                    break;
                case 9:
                    player.getPacketSender().sendMessage("Please let staff know about this. Error 92P79!");
                    break;
                case 10:
            ...
            switch (player.getDialogueActionId()) {
                ...
                case 2:
                    ...
                    break;
                case 9:
                    player.getPacketSender().sendMessage("Please let staff know about this. Error 92P78!");
                    break;
                case 10:
...
//				MySQLController.getStore().claim(player);
                ...
                case 18:
                    ...
                    break;
                case 26:
                    TeleportHandler.teleportPlayer(player, new Position(3085, 3482), player.getSpellbook().getTeleportType());
                    player.getPacketSender().sendRichPresenceState("Training Agility");
                    player.getPacketSender().sendSmallImageKey("agility");
                    player.getPacketSender().sendRichPresenceSmallPictureText("Lvl: " + player.getSkillManager().getCurrentLevel(Skill.AGILITY));
                    break;
                case 27:
            ...
            switch (player.getDialogueActionId()) {
                ...
                case 80:
                    if (player.getDifficulty() == Difficulty.Easy) {
                        ...
                        player.getPacketSender().sendInterfaceRemoval();
                        player.getPacketSender().sendMessage("Difficulty changed to: " + player.getDifficulty().toString());
                        PlayerPanel.refreshPanel(player);
                    }
                    break;
                case 81:
                ...
                case 84:
                    if (player.getEquipment().getFreeSlots() != player.getEquipment().capacity()) {
                        player.getPacketSender().sendMessage("You need to unequip your items first!");
                        player.getPacketSender().sendInterfaceRemoval();
                        return;
                    } else {
                        ...
                        player.getPacketSender().sendMessage("@red@Your skill levels have now been reset, you may now choose any difficulty.");
            ...
            switch (player.getDialogueActionId()) {
                ...
                case 22:
                    ...
                    break;
                case 25:
                    player.getPacketSender().sendRichPresenceState("Hunting at Puro Puro");
                ...
                case 56:
                    ...
                    break;
                case 58:
                    DialogueManager.start(player, AgilityTicketExchange.getDialogue(player, player.getDifficulty()));
                    break;
                case 61:
            ...
            switch (player.getDialogueActionId()) {
                ...
                case 25:
                    ...
                    player.getPacketSender().sendRichPresenceState("Hunting at Karamja");
                    player.getPacketSender().sendSmallImageKey("hunter");
                    player.getPacketSender().sendRichPresenceSmallPictureText("Lvl: " + player.getSkillManager().getCurrentLevel(Skill.HUNTER));
                ...
                case 43:
                    ...
                    break;
                case 47:
                    TeleportHandler.teleportPlayer(player, new Position(2735, 5334), player.getSpellbook().getTeleportType());
                    break;
                case 48:
                    if (player.getInteractingObject() != null) {
