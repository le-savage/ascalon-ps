package com.AscalonPS.world.content.combat.weapon;

import com.AscalonPS.engine.task.Task;
import com.AscalonPS.engine.task.TaskManager;
import com.AscalonPS.engine.task.impl.PlayerSpecialAmountTask;
import com.AscalonPS.engine.task.impl.StaffOfLightSpecialAttackTask;
...
import com.AscalonPS.world.content.Consumables;
...
public enum CombatSpecial {
    ...
    DRAGON_SPEAR(new int[]{21053, 1249, 1263, 5716, 5730}, 25, 1, 1, CombatType.MELEE, WeaponInterface.SPEAR) {
        @Override
        public CombatContainer container(Player player, Character target) {
