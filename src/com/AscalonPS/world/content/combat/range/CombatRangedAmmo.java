package com.AscalonPS.world.content.combat.range;
...
public class CombatRangedAmmo {
    ...
    public enum RangedWeaponData {
        ...
        TWISTED_BOW(new int[]{20998}, new AmmunitionData[]{AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.TWISTED_BOW),
    ...
    public enum AmmunitionData {
        ...
        DRAGON_ARROW(new int[]{11212}, 1111, 1120, 3, 44, 60, 43, 31),
        ...
        DRAGON_BOLT(new int[]{9341, 9244, 21040, 21049}, -1, 27, 3, 44, 95, 43, 31),
