package com.AscalonPS.world.content.combat.strategy;

import com.AscalonPS.world.content.combat.strategy.impl.*;

import java.util.HashMap;
import java.util.Map;
/*import com.janus.world.content.combat.strategy.impl.zulrah.BlueZulrah;
import com.janus.world.content.combat.strategy.impl.zulrah.CrimsonZulrah;
import com.janus.world.content.combat.strategy.impl.zulrah.GreenZulrah;*/
...
public class CombatStrategies {
    ...
    public static void init() {
        ...
        STRATEGIES.put(2005, defaultMagicStrategy);
        ;
		...
		STRATEGIES.put(2044, new BoringZulrah()); */
