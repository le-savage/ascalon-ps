...
import com.AscalonPS.world.content.combat.CombatContainer.CombatHit;
...
import com.AscalonPS.world.content.combat.range.CombatRangedAmmo.AmmunitionData;
import com.AscalonPS.world.content.combat.range.CombatRangedAmmo.RangedWeaponData;
import com.AscalonPS.world.content.combat.range.CombatRangedAmmo.RangedWeaponType;
...
public class DefaultRangedCombatStrategy implements CombatStrategy {
    ...
    public CombatContainer attack(Character entity, Character victim) {
        ...
        if (!player.isSpecialActivated() && !CombatFactory.crystalBow(player)) {
    ...
    public int attackDistance(Character entity) {
        ...
        if (player.getRegionInstance() != null && (player.getRegionInstance().equals(RegionInstance.RegionInstanceType.KRAKEN))) {
            distance += 3;
        }
