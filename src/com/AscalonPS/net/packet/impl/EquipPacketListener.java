        ...
        switch (interfaceId) {
            case Inventory.INTERFACE_ID:
                ...
                if (slot >= 0 && slot <= 28) {
					...
					/*if ((item.getId() == 21002) || (player.getSkillManager().getExperience(Skill.CONSTITUTION) > 500000000)) {
							player.getPacketSender().sendMessage("You need at least 500 million experience in Agility to be able to wear this item.");
							return;
						}*/
