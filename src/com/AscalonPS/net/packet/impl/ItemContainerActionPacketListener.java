...
import com.AscalonPS.world.content.Trading;
...
import com.AscalonPS.world.content.grandexchange.GrandExchangeOffer;
                ...
                if (player.isBanking()) {
                    if (interfaceId == 11) {
                        ...
                        if (player.getBank(Bank.getTabForItem(player, id)).getAmount(id) == 0) {
                            player.getBank(Bank.getTabForItem(player, id)).setItem(slot, new Item(-1));
