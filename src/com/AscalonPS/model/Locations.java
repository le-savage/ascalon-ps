...
import com.AscalonPS.world.content.PlayerPunishment.Jail;
...
import com.AscalonPS.world.content.combat.pvp.BountyHunter;
...
import com.AscalonPS.world.entity.Entity;
    ...
    public enum Location {
        DUNGEONEERING(new int[]{3433, 3459, 2421, 2499}, new int[]{3694, 3729, 4915, 4990}, true, false, true, false, true, false) {
            ...
            public void login(Player player) {
                player.getPacketSender().sendRichPresenceState("Dungeoneering");
        ...
        ZULRAH(new int[]{2257, 2281}, new int[]{3063, 3083}, true, true, true, false, true, true) {
            @Override
            public void leave(Player player) {
            ...
            @Override
            public boolean canTeleport(Player player) {
                World.getNpcs().forEach(n -> n.removeInstancedNpcs(Location.ZULRAH, player.getPosition().getZ()));
                return true;
            }
