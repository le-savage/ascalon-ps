package com.AscalonPS.model.container;

import com.google.common.collect.Iterables;
import com.AscalonPS.model.Flag;
import com.AscalonPS.model.GroundItem;
...
public abstract class ItemContainer {
    ...
    public void moveItems(ItemContainer to, boolean refreshOrig, boolean refreshTo) {
        ...
        for (Item it : getValidItems()) {
            ...
            /*if (to.getFreeSlots() < it.getAmount() && !it.getDefinition().isStackable()){
                player.getPacketSender().sendMessage("You don't have enough inventory space for this!");
                return;
            }*/
            to.add(it, false);
